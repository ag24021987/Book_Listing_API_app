...
public final class QueryUtils {
    ...
    public static ArrayList<Book> fetchBookData(String requestUrl) {
        ...
        ArrayList<Book> books = extractBookDataFromJson(jsonResponse);
     ...
     */
    private static ArrayList<Book> extractBookDataFromJson(String bookJSON) {
        // If the JSON string is empty or null, then return early.
        if (TextUtils.isEmpty(bookJSON)) {
            return null;
        }
        Log.e("QueryUtils", bookJSON);
            ...
            for (int i = 0; i < itemsArray.length(); i++) {
                ...
                if (bookAuthors != null) {
                    for (int j = 0; j < bookAuthors.length(); j++) {
                        bookAuthorsNames += bookAuthors.getString(j);
                ...
                books.add(new Book(bookTitle,bookAuthorsNames,publishedDate,webReaderLink));
            }
